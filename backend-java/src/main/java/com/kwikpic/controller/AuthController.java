...
import com.kwikpic.dto.LoginRequest;
import com.kwikpic.dto.PhotographerLoginRequest;
import com.kwikpic.dto.PhotographerSignupRequest;
import com.kwikpic.dto.SignupRequest;
import com.kwikpic.model.Photographer;
import com.kwikpic.model.User;
import com.kwikpic.repository.PhotographerRepository;
import com.kwikpic.repository.UserRepository;
import com.kwikpic.service.JwtService;
...
public class AuthController {
    ...
    private final com.kwikpic.service.EmailService emailService;

    public AuthController(UserRepository userRepository,
                          PhotographerRepository photographerRepository,
                          PasswordEncoder passwordEncoder,
                          JwtService jwtService,
                          com.kwikpic.service.EmailService emailService) {
    ...
    public ResponseEntity<Map<String, Object>> forgotPassword(@RequestBody com.kwikpic.dto.ForgotPasswordRequest req) {
        try {
    ...
    public ResponseEntity<Map<String, Object>> resetPassword(@RequestBody com.kwikpic.dto.ResetPasswordRequest req) {
        try {
            var optUser = userRepository.findByEmail(req.email());
            if (optUser.isEmpty()) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
    ...
    public ResponseEntity<Map<String, Object>> photographerForgotPassword(@RequestBody com.kwikpic.dto.ForgotPasswordRequest req) {
        try {
            var optPh = photographerRepository.findByEmail(req.email());
            if (optPh.isEmpty()) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
    ...
    public ResponseEntity<Map<String, Object>> photographerResetPassword(@RequestBody com.kwikpic.dto.ResetPasswordRequest req) {
        try {
            var optPh = photographerRepository.findByEmail(req.email());
            if (optPh.isEmpty()) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND)
