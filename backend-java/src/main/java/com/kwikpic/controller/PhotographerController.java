...
import com.kwikpic.dto.CreateGroupRequest;
import com.kwikpic.dto.DeletePhotosRequest;
...
public class PhotographerController {
    ...
    private final com.kwikpic.repository.PhotographerRepository photographerRepository;
    ...
    public PhotographerController(AuthResolverService authResolver,
                                  ...
                                  com.kwikpic.repository.PhotographerRepository photographerRepository) {
    ...
    public ResponseEntity<?> uploadPhotos(@PathVariable String code,
        ...
        try {
            ...
            for (MultipartFile file : files) {
                ...
                Map<String, Object> uploadResult = cloudinaryService.upload(fileBytes, "kwikpic/" + code);
